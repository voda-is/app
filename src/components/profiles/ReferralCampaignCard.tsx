    ...
    <div className="bg-white/10 backdrop-blur-md rounded-xl p-4">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-gray-100">Referral Campaign</h3>
        </div>
        <FiChevronDown className={`w-5 h-5 text-gray-100 transition-transform duration-300 ${isExpanded ? 'rotate-180' : ''}`} />
      </button>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-white/10 rounded-lg p-3">
                <div className="flex flex-col gap-2">
                  <div className="text-sm font-semibold text-emerald-400">+10 points</div>
